...
import { paramMapping } from "./utils.js";
...
export class Scraper {
    ...
    firstName;
    lastName;
    constructor(email = null, id = null, firstName = null, lastName = null) {
    ...
    async getPageByNameAndId(firstName, lastName, id) {
        const urlEncoded = new URLSearchParams();
        ...
        urlEncoded.append(paramMapping.lastName, lastName);
        urlEncoded.append(paramMapping.firstName, firstName);
